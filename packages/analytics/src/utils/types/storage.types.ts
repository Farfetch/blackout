export interface Storage {
  /**
   * @returns Returns the current value associated with the given key, or null if the given key does not
   * exist.
   */
   ...
   *
   * Throws a "QuotaExceededError" DOMException exception if the new value could not
   * be set. (Setting could fail if, e.g., the user has disabled storage for the

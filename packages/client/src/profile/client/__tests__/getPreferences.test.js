...
describe('getPreferences', () => {
  ...
  it('should handle a client request successfully', async () => {
    ...
    await expect(profileClient.getPreferences(mockUserId)).resolves.toBe(
      response,
    );
  ...
  it('should filter by code and handle a client request successfully', async () => {
    ...
    await expect(
      profileClient.getPreferences(mockUserId, mockCode),
  ...
  it('should receive a client request error', async () => {
    ...
    await expect(
      profileClient.getPreferences(mockUserId),

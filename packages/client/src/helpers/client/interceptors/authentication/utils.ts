 ...
 *
 * @returns Returns a new url string without the base url if the url contains it or the original url otherwise.
 */
 ...
 * @param optionValidator - A function that returns true if the optionValue is valid and false otherwise.
 * @param optionName - The option name. Used for the error message only.
 * @param errorMessageFormatter - A function that will format an error message to be used as the argument of the TypeError instance.
 *
 * @throws
 */

...
describe('Recently Viewed reducer', () => {
  ...
  describe('error() reducer', () => {
    ...
    it(`should handle ${actionTypes.GET_RECENTLY_VIEWED_PRODUCTS_FAILURE} action type`, () => {
    ...
    it(`should handle ${actionTypes.DELETE_RECENTLY_VIEWED_PRODUCT_FAILURE} action type`, () => {
      const state = reducer(undefined, {
  ...
  describe('isLoading() reducer', () => {
    ...
    it(`should handle ${actionTypes.GET_RECENTLY_VIEWED_PRODUCTS_REQUEST} action type`, () => {
    ...
    it(`should handle ${actionTypes.DELETE_RECENTLY_VIEWED_PRODUCT_REQUEST} action type`, () => {
      const expectedIsLoading = true;
      const state = reducer(undefined, {

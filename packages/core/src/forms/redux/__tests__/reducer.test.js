...
describe('forms redux reducer', () => {
  ...
  describe('error() reducer', () => {
    ...
    it('should handle GET_FORM_SCHEMA_FAILURE action type', () => {
      expect(
        reducer(undefined, {
    ...
    it('should handle GET_FORM_SCHEMA_SUCCESS action type', () => {
      expect(
        reducer(undefined, {
  ...
  describe('isLoading() reducer', () => {
    ...
    it('should handle GET_FORM_SCHEMA_REQUEST action type', () => {
      expect(
        reducer(undefined, {

...
const error = (
  ...
  switch (action.type) {
    case actionTypes.GET_PRODUCT_RECOMMENDATIONS_FAILURE:
      return {
        ...state,
...
const isLoading = (
  ...
  switch (action.type) {
    case actionTypes.GET_PRODUCT_RECOMMENDATIONS_REQUEST:
      return {
        ...state,
        [action.meta.strategyName]: true,
      };
    case actionTypes.GET_PRODUCT_RECOMMENDATIONS_SUCCESS:
      return {
        ...state,

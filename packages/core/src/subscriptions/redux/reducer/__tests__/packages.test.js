...
describe('Subscription Packages redux reducer', () => {
  describe('error() reducer', () => {
    ...
    it(`should handle ${actionTypes.GET_SUBSCRIPTION_PACKAGES_FAILURE} action type`, () => {
    ...
    it(`should handle ${actionTypes.GET_SUBSCRIPTION_PACKAGES_REQUEST} action type`, () => {
      expect(
        reducer(undefined, {
  ...
  describe('result() reducer', () => {
    ...
    it(`should handle ${actionTypes.GET_SUBSCRIPTION_PACKAGES_SUCCESS} action type`, () => {
      expect(
        reducer(undefined, {

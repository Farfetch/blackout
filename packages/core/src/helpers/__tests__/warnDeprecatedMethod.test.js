import { warnDeprecatedMethod } from '../';

describe('warnDeprecatedMethod()', () => {
  const spy = jest.spyOn(console, 'warn');
  const mockPackageInfo = '@farfetch/blackout@0.0.0';
  ...
  it('should warn a deprecated method with the newMethod option successfully', () => {
    ...
    expect(spy.mock.calls[0][0]).toMatchInlineSnapshot(
      '"@farfetch/blackout@0.0.0: DEPRECATED method \\"deprecatedFoo\\". Please use \\"newFoo\\" instead. This method will be removed in the next major release."',
    );
  });
  ...
  it('should warn a deprecated method without the newMethod option successfully', () => {
    ...
    expect(spy.mock.calls[0][0]).toMatchInlineSnapshot(
      '"@farfetch/blackout@0.0.0: DEPRECATED method \\"deprecatedFoo\\". This method will be removed in the next major release."',
    );
  });
});

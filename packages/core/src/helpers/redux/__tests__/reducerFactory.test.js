...
describe('reducerFactory', () => {
  ...
  const actionTypes = {
    ACTION_FACTORY_RESET: '@farfetch/blackout-core/ACTION_FACTORY_RESET',
    ACTION_FACTORY_REQUEST: '@farfetch/blackout-core/ACTION_FACTORY_REQUEST',
    ACTION_FACTORY_SUCCESS: '@farfetch/blackout-core/ACTION_FACTORY_SUCCESS',
    ACTION_FACTORY_FAILURE: '@farfetch/blackout-core/ACTION_FACTORY_FAILURE',
  };
  const initialState = {
    error: null,
    id: null,
...
describe('createReducerWithResult', () => {
  ...
  const actionTypes = {
    ...
    ACTION_FACTORY_SUCCESS: '@farfetch/blackout-core/ACTION_FACTORY_SUCCESS',
    ACTION_FACTORY_FAILURE: '@farfetch/blackout-core/ACTION_FACTORY_FAILURE',
    ACTION_FACTORY_2_RESET: '@farfetch/blackout-core/ACTION_FACTORY_2_RESET',
    ACTION_FACTORY_2_REQUEST:
      '@farfetch/blackout-core/ACTION_FACTORY_2_REQUEST',
    ACTION_FACTORY_2_SUCCESS:
      '@farfetch/blackout-core/ACTION_FACTORY_2_SUCCESS',
    ACTION_FACTORY_2_FAILURE:
      '@farfetch/blackout-core/ACTION_FACTORY_2_FAILURE',
  };
  const initialState = {
    error: null,
    result: 'mockResult',

...
describe('Addresses reducers', () => {
  ...
  describe('result() reducer', () => {
    ...
    it('should handle GET_ADDRESSES_SUCCESS action type', () => {
    ...
    it('should handle DELETE_ADDRESS_SUCCESS action type', () => {
      const state = { result: ['1', '2', '3'] };
  ...
  describe('error() reducer', () => {
    ...
    it.each([
      actionTypes.GET_PREDICTION_FAILURE,
      actionTypes.GET_PREDICTION_DETAILS_FAILURE,
      actionTypes.GET_ADDRESSES_FAILURE,
  ...
  describe('isLoading() reducer', () => {
    ...
    it.each([
      actionTypes.GET_PREDICTION_REQUEST,
      actionTypes.GET_PREDICTION_DETAILS_REQUEST,
      actionTypes.GET_ADDRESSES_REQUEST,
      actionTypes.GET_ADDRESS_REQUEST,
    ...
    it.each([
      actionTypes.GET_ADDRESSES_SUCCESS,
      actionTypes.GET_ADDRESS_SUCCESS,
    ...
    it.each([
      actionTypes.GET_ADDRESSES_FAILURE,
      actionTypes.GET_ADDRESS_FAILURE,
      actionTypes.CREATE_ADDRESS_FAILURE,
      actionTypes.UPDATE_ADDRESS_FAILURE,
      actionTypes.SET_DEFAULT_BILLING_ADDRESS_FAILURE,
      actionTypes.SET_DEFAULT_SHIPPING_ADDRESS_FAILURE,
  ...
  describe('predictions() reducer', () => {
    it.each([actionTypes.GET_PREDICTION_REQUEST])(
    ...
    it.each([actionTypes.GET_PREDICTION_FAILURE])(
      'should handle %s action type',
      actionType => {
        const error = 'foo';
        const reducerResult = reducer(undefined, {
    ...
    it.each([actionTypes.GET_PREDICTION_SUCCESS])(
      'should handle %s action type',
      actionType => {
        const payload = 'foo';
        const reducerResult = reducer(undefined, {
  ...
  describe('entitiesMapper()', () => {
    ...
    describe('Delete adressbook address', () => {
      ...
      it('should handle DELETE_ADDRESS_SUCCESS action type', () => {
        expect(
          entitiesMapper[actionTypes.DELETE_ADDRESS_SUCCESS](state, {
            meta: { addressId: 1 },
            type: actionTypes.DELETE_ADDRESS_SUCCESS,
          }),
        ).toEqual(expectedResult);
    ...
    describe('get an address schema', () => {
      ...
      it('should handle GET_ADDRESS_SCHEMA_SUCCESS action type', () => {
        expect(
          entitiesMapper[actionTypes.GET_ADDRESS_SCHEMA_SUCCESS](state, {
            payload: {
              result: countryId,
              entities: {
                addressSchema: {
    ...
    describe('Delete default contact address', () => {
      it('should handle DELETE_DEFAULT_CONTACT_ADDRESS_SUCCESS action type', () => {
        const state = {
          addresses: {
            1: {
              id: 1,
        ...
        expect(
          entitiesMapper[actionTypes.DELETE_DEFAULT_CONTACT_ADDRESS_SUCCESS](
            state,
            {
              meta: { addressId: 1 },
  ...
  describe('address() reducer', () => {
    ...
    it.each([
      actionTypes.GET_ADDRESS_REQUEST,
      actionTypes.DELETE_ADDRESS_REQUEST,
      actionTypes.SET_DEFAULT_BILLING_ADDRESS_REQUEST,
      actionTypes.SET_DEFAULT_SHIPPING_ADDRESS_REQUEST,
      actionTypes.SET_DEFAULT_CONTACT_ADDRESS_REQUEST,
      actionTypes.DELETE_DEFAULT_CONTACT_ADDRESS_REQUEST,
    ...
    it.each([
      actionTypes.GET_ADDRESS_FAILURE,
      actionTypes.DELETE_ADDRESS_FAILURE,
      actionTypes.SET_DEFAULT_BILLING_ADDRESS_FAILURE,
      actionTypes.SET_DEFAULT_SHIPPING_ADDRESS_FAILURE,
      actionTypes.SET_DEFAULT_CONTACT_ADDRESS_FAILURE,
      actionTypes.DELETE_DEFAULT_CONTACT_ADDRESS_FAILURE,
    ...
    it.each([
      actionTypes.GET_ADDRESS_SUCCESS,
      actionTypes.DELETE_ADDRESS_SUCCESS,
      actionTypes.SET_DEFAULT_BILLING_ADDRESS_SUCCESS,
      actionTypes.SET_DEFAULT_SHIPPING_ADDRESS_SUCCESS,
      actionTypes.SET_DEFAULT_CONTACT_ADDRESS_SUCCESS,
      actionTypes.DELETE_DEFAULT_CONTACT_ADDRESS_SUCCESS,

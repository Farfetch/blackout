...
export const getSiteFeaturesError = state => {
  warnDeprecatedMethod(
    ...
    '@farfetch/blackout-core/siteFeatures/redux/getSiteFeaturesError',
  );
...
export const getSiteFeaturesResult = state => {
  warnDeprecatedMethod(
    `${PCKG_NAME}@${PCKG_VERSION}`,
    '@farfetch/blackout-core/siteFeatures/redux/getSiteFeaturesResult',
  );
...
export const getSiteFeaturesIsLoading = state => {
  warnDeprecatedMethod(
    `${PCKG_NAME}@${PCKG_VERSION}`,
    '@farfetch/blackout-core/siteFeatures/redux/getSiteFeaturesIsLoading',
  );

import { getSpaceContentVersionPublications } from '..';
import client from '../../../../../helpers/client';
import fixtures from '../__fixtures__/getContentVersionPublications.fixtures';
import moxios from 'moxios';

describe('getContentVersionPublications', () => {
  ...
  it('should handle a client request successfully', async () => {
    ...
    await expect(
      getSpaceContentVersionPublications(spaceCode, contentId, versionId),

import { putSpaceContentVersionComponents } from '..';
import client from '../../../../../helpers/client';
import fixtures from '../__fixtures__/putContentVersionComponents.fixtures';
...
describe('getContentVersionComponents', () => {
  ...
  it('should handle a client request successfully', async () => {
    ...
    await expect(
      putSpaceContentVersionComponents(spaceCode, contentId, versionId, data),
    ).resolves.toBe(response);

    expect(spy).toHaveBeenCalledWith(
      `${endpoint}/${spaceCode}/contents/${contentId}/versions/${versionId}/components`,
      data,
      expectedConfig,
    );
  });

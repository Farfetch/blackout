import { getSpaceComponentVersionVariation } from '..';
import client from '../../../../../helpers/client';
import fixtures from '../__fixtures__/getComponentVersionVariation.fixtures';
import moxios from 'moxios';

describe('getComponentVersionVariation', () => {
  ...
  it('should handle a client request successfully', async () => {
    ...
    await expect(
      getSpaceComponentVersionVariation(
        spaceCode,
        componentCode,
        versionId,
        code,

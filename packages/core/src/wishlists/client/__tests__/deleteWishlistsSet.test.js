import { deleteWishlistsSet } from '..';
import {
  mockWishlistId,
  mockWishlistSetId,
} from 'tests/__fixtures__/wishlists';
import client from '../../../helpers/client';
import fixtures from '../__fixtures__/deleteWishlistsSet.fixtures';
import moxios from 'moxios';

describe('deleteWishlistsSet', () => {
  ...
  it('should handle a client request successfully', async () => {
    ...
    await expect(
      deleteWishlistsSet(wishlistId, wishlistSetId),

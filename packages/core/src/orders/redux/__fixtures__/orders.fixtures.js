...
export const merchantOrderCode = 'PZ1130383514';
export const merchantOrderCode2 = 'PZ1130238823';
export const merchantOrderCode3 = 'PZ1129578735';
...
export const mockOrdersResponse = {
  items: {
    entries: [
      ...
      {
        checkoutOrderId,
        createdDate: '/Date(1534245134007)/',
        id: orderId2,
        merchantId,
        merchantName: 'TOMAS MAIER MADISON',
...
// When spliByMerchantOrderCode flag is active the order entity is generated differently
export const expectedNormalizedPayloadSplitedByMerchantOrderCode = {
  entities: {
    orders: {
      [orderId]: {
        byMerchant: {
...
export const expectedOrderDetailsNormalizedPayloadSplitedByMerchantOrderCode = {
  entities: {
    brands: {
      220482: {
        description: 'German born Tomas Maier headed to Paris.',

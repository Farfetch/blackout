 ...
 */
export const getPrograms = state => getEntity(state, 'programs');
 ...
 */
export const getMembership = state => getEntity(state, 'membership');
 ...
 */
export const getReplacements = state => getEntity(state, 'replacements');
 ...
 */
export const getConverts = state => getEntity(state, 'converts');
 ...
 */
export const getStatements = state => getEntity(state, 'statements');

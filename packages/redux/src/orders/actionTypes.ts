...
export const FETCH_ORDER_RETURN_OPTIONS_SUCCESS =
  '@farfetch/blackout-redux/FETCH_ORDER_RETURN_OPTIONS_SUCCESS';
...
export const FETCH_SHIPMENT_TRACKINGS_FAILURE =
  '@farfetch/blackout-redux/FETCH_SHIPMENT_TRACKINGS_FAILURE';
/**
 * Action type dispatched when the fetch tracking request starts.
 */
export const FETCH_SHIPMENT_TRACKINGS_REQUEST =
  '@farfetch/blackout-redux/FETCH_SHIPMENT_TRACKINGS_REQUEST';
/**
 * Action type dispatched when the fetch tracking request succeeds.
 */
export const FETCH_SHIPMENT_TRACKINGS_SUCCESS =
  '@farfetch/blackout-redux/FETCH_SHIPMENT_TRACKINGS_SUCCESS';

/**
 * Action type dispatched when resetting the orders state.
 */
...
export const FETCH_ORDER_AVAILABLE_ITEMS_ACTIVITIES_FAILURE =
  '@farfetch/blackout-redux/FETCH_ORDER_AVAILABLE_ITEMS_ACTIVITIES_FAILURE';
/**
 * Action type dispatched when the fetch order available items activities request
 * starts.
 */
export const FETCH_ORDER_AVAILABLE_ITEMS_ACTIVITIES_REQUEST =
  '@farfetch/blackout-redux/FETCH_ORDER_AVAILABLE_ITEMS_ACTIVITIES_REQUEST';
/**
 * Action type dispatched when the fetch order available items activities request
 * succeeds.
 */
export const FETCH_ORDER_AVAILABLE_ITEMS_ACTIVITIES_SUCCESS =
  '@farfetch/blackout-redux/FETCH_ORDER_AVAILABLE_ITEMS_ACTIVITIES_SUCCESS';

...
export const LOGIN_RESET = '@farfetch/blackout-redux/LOGIN_RESET';
...
export const LOGOUT_RESET = '@farfetch/blackout-redux/LOGOUT_RESET';
...
export const PASSWORD_CHANGE_RESET =
  '@farfetch/blackout-redux/PASSWORD_CHANGE_RESET';
...
export const PASSWORD_RECOVER_RESET =
  '@farfetch/blackout-redux/PASSWORD_RECOVER_RESET';
...
export const PASSWORD_RESET_RESET =
  '@farfetch/blackout-redux/PASSWORD_RESET_RESET';
...
export const REGISTER_RESET = '@farfetch/blackout-redux/REGISTER_RESET';
...
export const VALIDATE_EMAIL_RESET =
  '@farfetch/blackout-redux/VALIDATE_EMAIL_RESET';
...
export const REFRESH_EMAIL_TOKEN_RESET =
  '@farfetch/blackout-redux/REFRESH_EMAIL_TOKEN_RESET';
...
/** Action type dispatched when the client wants to reset the delete user token request redux data. */
export const DELETE_USER_TOKEN_RESET =
  '@farfetch/blackout-redux/DELETE_USER_TOKEN_RESET';
...
/** Action type dispatched when thedelete user impersonation request succeeds.*/
export const DELETE_USER_IMPERSONATION_SUCCESS =
  '@farfetch/blackout-redux/DELETE_USER_IMPERSONATION_SUCCESS';
/** Action type dispatched when the client wants to reset the delete user impersonation request redux data. */
export const DELETE_USER_IMPERSONATION_RESET =
  '@farfetch/blackout-redux/DELETE_USER_IMPERSONATION_RESET';
...
/** Action type dispatched when the client wants to reset the create user impersonation request redux data. */
export const CREATE_USER_IMPERSONATION_RESET =
  '@farfetch/blackout-redux/CREATE_USER_IMPERSONATION_RESET';
...
/** Action type dispatched when the client wants to reset the create user token request redux data. */
export const CREATE_USER_TOKEN_RESET =
  '@farfetch/blackout-redux/CREATE_USER_TOKEN_RESET';
...
/** Action type dispatched when thecreate client credentials request succeeds.*/
export const CREATE_CLIENT_CREDENTIALS_TOKEN_SUCCESS =
  '@farfetch/blackout-redux/CREATE_CLIENT_CREDENTIALS_TOKEN_SUCCESS';
/** Action type dispatched when the client wants to reset the create client credentials token request redux data. */
export const CREATE_CLIENT_CREDENTIALS_TOKEN_RESET =
  '@farfetch/blackout-redux/CREATE_CLIENT_CREDENTIALS_TOKEN_RESET';
...
/** Action type dispatched when the client wants to reset the refresh user token request redux data. */
export const REFRESH_USER_TOKEN_RESET =
  '@farfetch/blackout-redux/REFRESH_USER_TOKEN_RESET';

/** Action type dispatched when the client wants to reset the token request redux data. */
export const AUTHENTICATION_RESET =
  '@farfetch/blackout-redux/AUTHENTICATION_RESET';

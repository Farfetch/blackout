...
describe('authentication reducer', () => {
  ...
  describe('error() reducer', () => {
    it('should return the initial state', () => {
      const state = reducer(undefined, mockAction).error;
    ...
    it('should handle other actions by returning the previous state', () => {
      ...
      expect(reducer(state as State, mockAction).error).toBe(state.error);
    });
  });

  describe('isLoading() reducer', () => {
    it('should return the initial state', () => {
      const state = reducer(undefined, mockAction).isLoading;
    ...
    it('should handle other actions by returning the previous state', () => {
      ...
      expect(reducer(state as State, mockAction).isLoading).toBe(
        state.isLoading,
      );
    });
  });
  ...
  describe('id() reducer', () => {
    it('should return the initial state', () => {
      const state = reducer(undefined, mockAction).id;
    ...
    it('should handle other actions by returning the previous state', () => {
      ...
      expect(reducer(state as State, mockAction).id).toBe(state.id);
    });
  });
  ...
  describe('userToken() reducer', () => {
    ...
    it(`should handle ${actionTypes.DELETE_USER_TOKEN_SUCCESS} action type`, () => {
      ...
      const reducerResult = reducer(state as State, {
    ...
    it('should handle other actions by returning the previous state', () => {
      ...
      expect(reducer(state as State, mockAction).userToken).toBe(
        state.userToken,
      );
    });
  });
  ...
  describe('userImpersonation() reducer', () => {
    ...
    it('should handle other actions by returning the previous state', () => {
      ...
      expect(reducer(state as State, mockAction).userImpersonation).toBe(
  ...
  describe('entitiesMapper()', () => {
    describe('for LOGOUT_SUCCESS', () => {
      ...
      it('should handle LOGOUT_SUCCESS action type', () => {
        expect(entitiesMapper[actionTypes.LOGOUT_SUCCESS](state)).toEqual(
          newState,
        );
      });
    });

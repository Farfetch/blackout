...
export const REMOVE_PAYMENT_TOKEN_FAILURE =
  '@farfetch/blackout-redux/REMOVE_PAYMENT_TOKEN_FAILURE';
/** Action type dispatched when the remove payment token request starts. */
export const REMOVE_PAYMENT_TOKEN_REQUEST =
  '@farfetch/blackout-redux/REMOVE_PAYMENT_TOKEN_REQUEST';
/** Action type dispatched when the remove payment token request succeeds. */
export const REMOVE_PAYMENT_TOKEN_SUCCESS =
...
/** Action type dispatched when the fetch payment tokens request starts. */
export const FETCH_PAYMENT_TOKENS_REQUEST =
  '@farfetch/blackout-redux/FETCH_PAYMENT_TOKENS_REQUEST';
/** Action type dispatched when the fetch payment tokens request succeeds. */
export const FETCH_PAYMENT_TOKENS_SUCCESS =
...
/** Action type dispatched when the fetch payment methods by country and currency request fails. */
export const FETCH_PAYMENT_METHODS_BY_COUNTRY_AND_CURRENCY_FAILURE =
  '@farfetch/blackout-redux/FETCH_PAYMENT_METHODS_BY_COUNTRY_AND_CURRENCY_FAILURE';
/** Action type dispatched when the fetch payment methods by country and currency request starts. */
export const FETCH_PAYMENT_METHODS_BY_COUNTRY_AND_CURRENCY_REQUEST =
  '@farfetch/blackout-redux/FETCH_PAYMENT_METHODS_BY_COUNTRY_AND_CURRENCY_REQUEST';
/** Action type dispatched when the fetch payment methods by country and currency request succeeds. */
export const FETCH_PAYMENT_METHODS_BY_COUNTRY_AND_CURRENCY_SUCCESS =
  '@farfetch/blackout-redux/FETCH_PAYMENT_METHODS_BY_COUNTRY_AND_CURRENCY_SUCCESS';

/** Action type dispatched when the fetch payment methods by intent fails. */
export const FETCH_PAYMENT_METHODS_BY_INTENT_FAILURE =
  '@farfetch/blackout-redux/FETCH_PAYMENT_METHODS_BY_INTENT_FAILURE';
/** Action type dispatched when the get payment methods by intent starts. */
export const FETCH_PAYMENT_METHODS_BY_INTENT_REQUEST =
  '@farfetch/blackout-redux/FETCH_PAYMENT_METHODS_BY_INTENT_REQUEST';
/** Action type dispatched when the get payment methods by intent succeeds. */
export const FETCH_PAYMENT_METHODS_BY_INTENT_SUCCESS =
...
export const FETCH_GIFT_CARD_BALANCE_FAILURE =
  '@farfetch/blackout-redux/FETCH_GIFT_CARD_BALANCE_FAILURE';
/** Action type dispatched when the fetch gift card balance request starts. */
export const FETCH_GIFT_CARD_BALANCE_REQUEST =
  '@farfetch/blackout-redux/FETCH_GIFT_CARD_BALANCE_REQUEST';
/** Action type dispatched when the fetch gift card balance request succeeds. */

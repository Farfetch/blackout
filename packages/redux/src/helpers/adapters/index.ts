...
export { default as adaptDate } from './adaptDate';
...
export { default as adaptGrouping } from './adaptGrouping';
export { default as adaptGroupingProperties } from './adaptGroupingProperties';

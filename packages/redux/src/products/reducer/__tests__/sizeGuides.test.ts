...
describe('sizeGuides redux reducer', () => {
  ...
  describe('error() reducer', () => {
    ...
    it('should handle FETCH_PRODUCT_SIZEGUIDES_REQUEST action type', () => {
  ...
  describe('isLoading() reducer', () => {
    ...
    it('should handle FETCH_PRODUCT_SIZEGUIDES_SUCCESS action type', () => {
      const expectedIsLoading = {
        [mockProductId]: false,
      };
      const state = reducer(undefined, {

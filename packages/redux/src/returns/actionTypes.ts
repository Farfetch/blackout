...
export const FETCH_PICKUP_CAPABILITIES_FAILURE =
  '@farfetch/blackout-client/FETCH_PICKUP_CAPABILITIES_FAILURE';
/** Action type dispatched when the get pickup capabilities request starts. */
export const FETCH_PICKUP_CAPABILITIES_REQUEST =
  '@farfetch/blackout-client/FETCH_PICKUP_CAPABILITIES_REQUEST';
/** Action type dispatched when the get pickup capabilities request succeeds. */
export const FETCH_PICKUP_CAPABILITIES_SUCCESS =
  '@farfetch/blackout-client/FETCH_PICKUP_CAPABILITIES_SUCCESS';

/** Action type dispatched when the get references request fails. */
export const FETCH_REFERENCES_FAILURE =
  '@farfetch/blackout-client/FETCH_REFERENCES_FAILURE';
/** Action type dispatched when the get references request starts. */
export const FETCH_REFERENCES_REQUEST =
  '@farfetch/blackout-client/FETCH_REFERENCES_REQUEST';
/** Action type dispatched when the get references request succeeds. */
export const FETCH_REFERENCES_SUCCESS =
  '@farfetch/blackout-client/FETCH_REFERENCES_SUCCESS';

...
/** Action type dispatched when reseting the charges state. */
...
/** Action type dispatched when the fetch item delivery provisioning
 *  request fails. */
...
/** Action type dispatched when the fetch delivery bundle upgrades
 * request starts. */
...
/** Action type dispatched when the fetch item delivery provisionin
 * request starts. */
...
/** Action type dispatched when the fetch item delivery provisioni
 * request succeeds. */

...
export const mockCustomListingPageSlug = '/customlistingpage';
...
export const mockCustomListingPageHash = 'listing/customlistingpage';
      ...
      [mockProductsListHash]: {
        ...
        filterSegments: [
            ...
            .productsLists[mockProductsListHash].filterSegments,
          {
            ...
            description: 'XS',
            facetId:
              'sizesbycategory_19_182544_listing/woman/clothing?categories=135971&colors=6&pageindex=1',
          },
          {
            order: 0,
            type: 24,
            ...
            description: 'S',
            facetId:
              'sizesbycategory_20_182569_listing/woman/clothing?categories=135971&colors=6&pageindex=1',
          },
        ],
      },
    },
...
export const mockCustomListingPage = {
  slug: mockCustomListingPageSlug,
  subfolder: 'us',
  config: {
    pageIndex: 1,
  },

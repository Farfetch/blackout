import { imageGroup } from './product.fixtures.mjs';
import { mockBreadCrumbs } from './products.fixtures.mjs';
import { mockPriceResponse } from './price.fixtures.mjs';
import { mockProductAttributes } from './productAttributes.fixtures.mjs';
import { mockProductId, mockSetId, mockSizeScaleId } from './ids.fixtures.mjs';
...
export const mockProductsEntity = {
  [mockProductId]: {
    customAttributes: null,
    images: [
      {
        ...
        order: 1,
        sources: {
          120: 'https://cdn-images.farfetch-contents.com/services-unknown-x-east-stadium-goods-tri-band-hoodie_14074610_18494976_120.jpg?c=2',
        },
      },
    ],
    sizes: [

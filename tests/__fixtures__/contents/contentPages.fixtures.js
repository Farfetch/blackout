...
export const slugContent = '/shopping/woman/gucci';
export const typeContent = 'LISTING';
...
export const contentPagesHash = buildContentGroupHash(contentQuery);
  ...
  entities: {
    contentGroups: {
      [contentPagesHash]: {
        ...
        totalPages: 1,
        totalItems: 1,
        entries: [mockContentPages.entries[0].publicationId],
      },
    },
    contents: {
      [mockContentPages.entries[0].publicationId]: {
        ...mockContentPages.entries[0],
      },
    },
  },
  contents: {
    isLoading: {
      [contentPagesHash]: false,
    },
    error: {},
  },
};
